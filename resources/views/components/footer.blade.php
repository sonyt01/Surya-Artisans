...
<footer class="bg-[#800000] text-[#F5E6D3] mt-16">
    <div class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">

        <!-- Brand -->
        <div>
            <h2 class="text-xl font-bold text-white mb-4 font-serif">
                Surya Artisans
            </h2>
            ...
            <div class="flex space-x-6">
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/suryaartisan/" class="hover:text-pink-300 transition">
                    <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                ...
                <!-- Phone -->
                <a href="tel:+61410926011" class="hover:text-green-300 transition">
                    <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                ...
                <!-- WhatsApp -->
                <a href="https://wa.me/61410926011" class="hover:text-green-400 transition">
                    <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                        <path d="M20.5 3.5A11.95 11.95 0 0 0 12 0C5.37 0 0 5.37 0 12c0 2.12.55 4.12 1.52 5.88L0 24l6.33-1.52A11.944 11.944 0 0 0 12 24c6.63 0 12-5.37 12-12 0-3.19-1.24-6.22-3.5-8.5z"/>
                    </svg>
                </a>
        ...
        <div>
            ...
            <ul class="space-y-2">
                ...
                <li><a href="{{ route('productsView') }}" class="hover:text-white">Products</a></li>
    ...
    <!-- Bottom -->
    <div class="border-t border-[#A0522D] text-center py-4 text-sm text-[#F5E6D3]">
